...
namespace UER
{
	namespace raytracing {
		...
		)
		{
			...
			auto ds_size_cbv_srv_uav = d3dDevice->GetDescriptorHandleIncrementSize(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV);
			auto hitGroup_pbrCameraRaySrvHeapStride =
				ds_size_cbv_srv_uav * (int)EHitGroup_PBRMaterialHitSRV::eNum;
