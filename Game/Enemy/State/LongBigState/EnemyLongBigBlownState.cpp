#include "stdafx.h"
#include "EnemyLongBigBlownState.h"
#include "Enemy/IEnemy.h"
#include "Enemy/EnemyManager.h"
#include "Enemy/Zako/Zako_LongBig.h"
#include "Effect/ExplosionEffect.h"

EnemyLongBigBlownState::EnemyLongBigBlownState()
{
...
void EnemyLongBigBlownState::Enter(IEnemy* e)
{
	auto ene = reinterpret_cast<Zako_LongBig*>(e);
	...
	if (m_ik[0] == nullptr)
	{
		...
		m_ik[i++] = e->GetIK(TO_INT(Zako_LongBig::EIK::Foot1));
		m_ik[i++] = e->GetIK(TO_INT(Zako_LongBig::EIK::Foot2));
		m_ik[i++] = e->GetIK(TO_INT(Zako_LongBig::EIK::Foot3));
		m_ik[i++] = e->GetIK(TO_INT(Zako_LongBig::EIK::Foot4));
		for (auto ik : m_ik)
		{
			if (ik == nullptr)
				continue;
...
IEnemyState* EnemyLongBigBlownState::Update(IEnemy* e)
{
...
void EnemyLongBigBlownState::Exit(IEnemy* e)
{
}
